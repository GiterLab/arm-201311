...
\subsubsection[{\-Oggz\-Read\-Packet}]{\setlength{\rightskip}{0pt plus 5cm}typedef int($\ast$ {\bf \-Oggz\-Read\-Packet})({\bf \-O\-G\-G\-Z} $\ast$oggz, ogg\-\_\-packet $\ast$op, long serialno, void $\ast$user\-\_\-data)}\label{group__read__api_gaef015044907510cda7a3c06241e959e7}
...
\hline
{\em op} & \-The full ogg\-\_\-packet (see $<$ogg/ogg.\-h$>$) \\
\hline
{\em serialno} & \-Identify the logical bistream in {\itshape oggz\/} that contains {\itshape op\/} \\
\hline
...
\subsubsection[{\-Oggz\-Read\-Page}]{\setlength{\rightskip}{0pt plus 5cm}typedef int($\ast$ {\bf \-Oggz\-Read\-Page})({\bf \-O\-G\-G\-Z} $\ast$oggz, const ogg\-\_\-page $\ast$og, long serialno, void $\ast$user\-\_\-data)}\label{group__read__api_ga8a1df0166fad1a0a6fe55d24e1a4b2e6}
...
\subsubsection[{oggz\-\_\-read}]{\setlength{\rightskip}{0pt plus 5cm}long {\bf oggz\-\_\-read} (
...
\subsubsection[{oggz\-\_\-read\-\_\-input}]{\setlength{\rightskip}{0pt plus 5cm}long {\bf oggz\-\_\-read\-\_\-input} (
\begin{DoxyParamCaption}
\item[{{\bf \-O\-G\-G\-Z} $\ast$}]{oggz, }
...
\subsubsection[{oggz\-\_\-set\-\_\-read\-\_\-callback}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf oggz\-\_\-set\-\_\-read\-\_\-callback} (
\begin{DoxyParamCaption}
\item[{{\bf \-O\-G\-G\-Z} $\ast$}]{oggz, }
\item[{long}]{serialno, }
...
\subsubsection[{oggz\-\_\-set\-\_\-read\-\_\-page}]{\setlength{\rightskip}{0pt plus 5cm}int {\bf oggz\-\_\-set\-\_\-read\-\_\-page} (
\begin{DoxyParamCaption}
\item[{{\bf \-O\-G\-G\-Z} $\ast$}]{oggz, }
\item[{long}]{serialno, }
