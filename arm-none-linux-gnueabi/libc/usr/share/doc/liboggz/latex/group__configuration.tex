...
\-For general information about using ./configure, see the file \doxyref{\-I\-N\-S\-T\-A\-L\-L }{p.}{group__install}\subsubsection{\-Removing writing support}\label{group__configuration_no_encode}
